...
function TaskCard({ task, deleteTask, updateTask }: Props) {
  ...
  return (
    <div
      ...
      className="bg-mainBackgroundColor p-2.5 h-[100px] min-h-[100px] items-center flex flex-col text-left rounded-xl
        border border-gray-300 hover:border-rose-500 hover:ring-2 hover:ring-inset cursor-grab relative task"
      onMouseEnter={() => {
        setMouseIsOver(true);
      }}
      onMouseLeave={() => {
    ...
    >
      <p className="my-auto h-[90%] w-full overflow-auto overflow-x-hidden whitespace-pre-wrap mb-2">
        {task.titulo}
      </p>
